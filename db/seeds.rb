...
Filme.create(titulo: "Alice no País das Maravilhas", duracao: "108", ano: "2010", formato_id: 1, usuario_id: 1)

Serie.create(titulo: "The Originals", formato_id: 1, usuario_id: 1)
